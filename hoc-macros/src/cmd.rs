...
use proc_macro_error::{abort, abort_call_site, emit_warning, set_dummy};
use quote::quote;
use rand::Rng;
use syn::{
    punctuated::{IntoIter, Punctuated},
    visit_mut::VisitMut,
    AttributeArgs, Expr, ExprAssign, ExprLit, ExprPath, Item, Lit, Meta, MetaNameValue, NestedMeta,
